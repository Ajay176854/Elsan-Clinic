...
export default function HeroWidgets() {
  return (
    <div className="space-y-6 w-full">
      ...
      <div className="relative w-full h-[320px] sm:h-[420px] md:h-[550px] rounded-[32px] overflow-hidden flex items-center justify-center shadow-lg group">
        ...
        {/* Widget Container - Full width to push cards to the edges (sm and up only) */}
        <div className="hidden sm:block absolute inset-0 w-full h-full p-4 md:p-6 pointer-events-none">
      ...
      {/* Mobile Widgets Stack (visible below sm) */}
      <div className="grid grid-cols-1 gap-3 sm:hidden">
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              <h3 className="text-slate-800 font-bold text-sm leading-tight">Online Telemedicine</h3>
              <span className="bg-blue-100 text-blue-600 text-[8px] font-bold px-1.5 py-0.5 rounded uppercase tracking-wider">Live</span>
            </div>
            <p className="text-slate-550 text-xs">Virtual doctor consultations available</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-2 mb-0.5">
              <h3 className="text-slate-800 font-bold text-sm leading-tight">Top Rated Clinic</h3>
              <span className="text-slate-800 font-bold text-xs bg-amber-50 text-amber-700 px-1.5 py-0.5 rounded">4.9/5</span>
            </div>
            <p className="text-slate-550 text-xs">Based on 2,500+ patient reviews</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-slate-800 font-bold text-sm leading-tight">Trusted by Families</h3>
              <p className="text-slate-550 text-xs">Serving Chennai for over 20 years</p>
            </div>
          </div>
          <div className="text-right shrink-0">
            <p className="text-lg font-bold text-slate-800 leading-none">10k+</p>
            <p className="text-slate-500 text-[8px] font-bold uppercase tracking-wider">Patients</p>
          </div>
        </div>
      </div>
    </div>
